...
export function useDataTable<TData>({
  ...
  //* Search params
  const search = dataTableSearchParamsSchema.parse(Object.fromEntries(searchParams))
  ...
  const advancedFilter = search.advanced_filter
  ...
  }, [pageIndex, pageSize, sorting, method, advancedFilter, scroll])
